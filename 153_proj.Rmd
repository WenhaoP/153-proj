...
With consideration of cross-validation error, model AIC, model AICc, model BIC, the MA(4) model has the best performance. See the code appendix for more details about selection. We plot the model diagnostics methods in Figure TODO to further assess MA(4$. 
...
```
The performance of the diagnostics plots is similar to that of the previous three models, which means our model choice here is reasonable. 
