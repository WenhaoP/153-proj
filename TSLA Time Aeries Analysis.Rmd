...
```{r}
stock_new = read.csv("/Users/charlottewang/Desktop/TSLA_new.csv")
...
```
Figure .
The figure above displays the comparison between the forecasted and actual values of Tesla stock price in the analyzed period. With the 95% prediction interval, it is shown that our model fits four out of ten days appropriately; however, since Elon Musk sold 10% of his Tesla holding on November 7, its share price sharply decreased, which lead to a significant deviation from the predicted value.
