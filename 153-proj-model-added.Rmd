...
We perform time-series cross validation on the last 100 data points. For the model, we generate forecasts for every 10 days (2 weeks) and compute the sum of squares of errors of the forecasts. Then average the sum of squares of errors of forecasts over the days considered, which generates the mse of this model.
